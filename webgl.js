...
Name: Shaiza Hashmi
Date: March 08 2022
Assignment: CIS4800 Assignment 3
...
function main() {
  ...
  // Fragment shader program
	...
	// Look up which attributes our shader program is using for aVertexPosition, aVertexNormal, 
	// aTextureCoord, and look up uniform locations.
	const programInfo = {
	...
	function render(now) {
		...
		then = now;
		console.log("width x height: " + imageWidth + " x " + imageHeight)
...
function drawScene(gl, programInfo, buffers, texture, deltaTime) {
	...
	mat4.rotateX(modelViewMatrix, modelViewMatrix, 0.75, [0, 0, 1]);	//rotates towards me
	...
	// Tell WebGL how to pull out the normals from the normal buffer into the vertexNormal attribute.
	{
		...
		gl.vertexAttribPointer( programInfo.attribLocations.vertexNormal, numComponents,
	...
	gl.uniform1i(programInfo.uniformLocations.uSampler, 0); // Tell shader we bound the texture to texture unit 0
